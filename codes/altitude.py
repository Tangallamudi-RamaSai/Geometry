...
sys.path.insert(0, '/sdcard/geometry/geometry/Codes/CoordGeo')        #path to my scripts
import numpy as np
...
plt.plot(x_EH[0,:],x_EH[1,:],'--',label='$EH$')
plt.plot(x_FH[0,:],x_FH[1,:],'--',label='$FH$')

#Labeling the coordinates
tri_coords = np.block([[B,E,C,F]])
...
#if using termux
plt.savefig('/sdcard/geometry/geometry/figs/BECF')
